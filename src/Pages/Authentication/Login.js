        ...
        <Row className="justify-content-center">
          <Col lg={6} md={8} xl={4}>
                        ...
                        <Row>
                          ...
                          {/* <Col className="col-7">
                            <div className="text-md-end mt-3 mt-md-0">
                              ...
                              >
                                <i className="mdi mdi-lock"></i>  your
                                password?
                              </Link>
                            </div>
                          </Col> */}
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-white-50">
                © {new Date().getFullYear()} Technical Hub. Crafted with{" "}
                <i className="mdi mdi-heart text-danger"></i> by veda developer's team
              </p>
            </div>
          </Col>
        </Row>
